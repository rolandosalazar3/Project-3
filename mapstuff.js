...
var queryUrl = "https://github.com/rolandosalazar3/Project-3.git/api/v1.0/lat_long";
...
function createFeatures(schoolData) {
  ...
  function onEachFeature(feature, layer) {
    layer.bindPopup("Rank: " + Rank_USNewsWorldReport + "<br>Name: " + Name + "<br>Location: " + City + "," + state_code + "<br> Year Founded: " + yearFounded + "<br> Website: " + website[2]);
  }
